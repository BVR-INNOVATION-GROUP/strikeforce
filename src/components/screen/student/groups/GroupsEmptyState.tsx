 ...
 * Provides clear call-to-action for creating first group
 */
const GroupsEmptyState = ({ onCreateGroup }: Props) => {
  return (
    <motion.div
    ...
    >
      ...
      <p className="text-[0.875rem] opacity-60 mb-6 max-w-md mx-auto">
        Create a group to collaborate with other students and apply for projects
        together
      </p>
      <Button onClick={onCreateGroup} className="bg-primary">
