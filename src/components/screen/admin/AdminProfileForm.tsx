/**
 * Admin Profile Form Component (Shared for University Admin and Super Admin)
 */
"use client";
...
/**
 * Reusable profile form for admin users
 */
const AdminProfileForm = ({ user, formData, onFieldChange }: Props) => {
  return (
    <>
