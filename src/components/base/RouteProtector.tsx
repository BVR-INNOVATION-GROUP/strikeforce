...
/**
 * Route Protector Component - Protection Disabled
 * All route protection has been removed
 */
"use client";
...
/**
 * Route Protector component - Protection Disabled
 * Simply renders children without any authentication or authorization checks
 */
export default function RouteProtector({ children, allowedRoles }: Props) {
  // All route protection disabled - render children directly
  return <>{children}</>;
}
