    ...
    return (
        <div className={`flex flex-col gap-1 ${className}`}>
            ...
            <div className="relative">
                <input
                    type="text"
                    className={`border p-3 text-sm min-h-[44px] sm:min-h-0 border-custom rounded-lg outline-none w-full ${rightElement ? 'pr-10' : ''} ${error ? 'border-red-500 focus:border-red-500' : 'focus:border-primary'
                        }`}
