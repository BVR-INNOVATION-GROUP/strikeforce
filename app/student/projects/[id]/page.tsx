...
/**
 * Project Details Page - Shared across all user roles
 * Adapts based on user role (partner, student, etc.)
...
export default function ProjectDetailsPage() {
    ...
    // User is already initialized by AuthInitializer
    // Just set loading to false once user is available
    useEffect(() => {
        if (user) {
