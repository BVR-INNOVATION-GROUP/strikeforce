...
export default function PartnerSignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      // Similar to university signup - create user first, then organization
      ...
      if (status === 201 || status === 200) {
        ...
        const res2 = await POST<OrgRequest>("api/v1/org", {
        ...
        showError(msg || "Failed to create user account");
      }
    } catch (error: any) {
    ...
    <div className="flex items-center justify-center min-h-screen bg-pale py-8 px-4">
      <Card className="max-w-3xl w-full max-h-[95vh] overflow-y-auto">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold mb-2 text-default">Partner Organization Sign Up</h1>
