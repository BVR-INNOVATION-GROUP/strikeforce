...
/**
 * Universities Page - View and manage university organizations only
...
export default function UniversitiesPage() {
    ...
    const fetchOrganizations = async () => {
        try {
            ...
            // Filter only UNIVERSITY organizations
            ...
            <div className="flex gap-2 mb-6 border-b border-custom">
                {(
                    ...
                    <button
                        ...
                        className={`px-4 py-2 text-[0.875rem] font-medium border-b-2 transition-colors ${activeTab === tab.key
